...
public class WebviewCookieManagerPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private void hasCookies(final Result result) {
    ...
    private void setCookies(final MethodCall methodCall, final Result result) {
        ...
        for (Map<String, Object> cookieMap : serializedCookies) {
            String domainString = cookieMap.get("origin") instanceof String ? (String) cookieMap.get("origin") :
                    (cookieMap.get("domain") instanceof String ? (String) cookieMap.get("domain") : "");
    ...
    private Map<String, Object> cookieToMap(HttpCookie cookie) {
